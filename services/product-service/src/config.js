/**
 * Product Service configuration (US-SYS-7 AC5).
 */
...
export const config = loadEnv({
  ...
  PRODUCT_SERVICE_PORT: envField.port(4002),
  ...
  CACHE_TTL_SECONDS: envField.int(300),
  CATEGORY_CACHE_TTL_SECONDS: envField.int(3600),
});
